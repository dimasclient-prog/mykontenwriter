import { User, MapPin, Briefcase, Users, AlertTriangle, MessageSquare } from 'lucide-react';
...
export function PersonaDetailModal({ persona, open, onOpenChange }: PersonaDetailModalProps) {
